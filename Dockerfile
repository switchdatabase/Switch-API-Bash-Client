...
# Setup prompt
#
RUN echo 'export PS1="[Switch Database REST API] \$ "' >> ~/.bashrc
RUN echo 'export PROMPT="[Switch Database REST API] \$ "' >> ~/.zshrc
...
line REST client for $(tput setaf 6)Switch Database REST API$(tput sgr0).\n\
\n\
